...
export type RemediationStatus = "open" | "in_progress" | "awaiting_review" | "closed";
export type RemediationPriority = "low" | "medium" | "high" | "critical";
export type RemediationEvidence = { id: string; actionID: string; originalName: string; mimeType: string; sizeBytes: number; uploadedBy: string; createdAt: string };
...
export type RemediationCreateInput = Pick<RemediationAction, "subcategoryID" | "title" | "description" | "desiredResult" | "priority" | "ownerUserID" | "dueDate">;
export type RemediationPatchInput = Partial<Pick<RemediationAction, "title" | "description" | "desiredResult" | "priority" | "ownerUserID" | "dueDate">>;
export type RemediationSummary = { openCount: number; inProgressCount: number; awaitingReviewCount: number; overdueCount: number; closedCount: number };
