...
export function AuditPackageView({ auditPackage, onBack, onDownloadCSV }: Props) {
  ...
  return (
    <main className="report-page audit-page">
      ...
      <section className="report-section" aria-labelledby="scope-assignment-title">
        <div className="report-section-heading"><div><span className="eyebrow">01</span><h2 id="scope-assignment-title">Scope &amp; assignment</h2></div><span className="muted">{auditPackage.scope.length} catalog outcomes</span></div>
        <div className="report-table-wrap" role="region" tabIndex={0} aria-label="Scope and assignment report table"><table className="report-table"><thead><tr><th>Outcome</th><th>Included</th><th>Rationale</th><th>Assigned assessor</th></tr></thead><tbody>
      ...
      <section className="report-section" aria-labelledby="evidence-register-title">
        <div className="report-section-heading"><div><span className="eyebrow">02</span><h2 id="evidence-register-title">Evidence register</h2></div><span className="muted">{summary.evidenceCount} files</span></div>
        <div className="report-table-wrap" role="region" tabIndex={0} aria-label="Evidence register report table"><table className="report-table"><thead><tr><th>Outcome</th><th>File</th><th>Type</th><th>Uploaded</th><th>Size</th></tr></thead><tbody>
      ...
      <section className="report-section" aria-labelledby="review-history-title">
        <div className="report-section-heading"><div><span className="eyebrow">03</span><h2 id="review-history-title">Review history</h2></div><span className="muted">Response decisions</span></div>
        <div className="report-table-wrap" role="region" tabIndex={0} aria-label="Review history report table"><table className="report-table"><thead><tr><th>Outcome</th><th>Status</th><th>Reviewer comment</th><th>Reviewed at</th></tr></thead><tbody>
      ...
      <section className="report-section" aria-labelledby="audit-trail-title">
        <div className="report-section-heading"><div><span className="eyebrow">05</span><h2 id="audit-trail-title">Audit trail</h2></div><span className="muted">Chronological activity</span></div>
      ...
      <section className="report-section" aria-labelledby="remediation-register-title">
        <div className="report-section-heading"><div><span className="eyebrow">04</span><h2 id="remediation-register-title">Remediation register</h2></div><span className="muted">{auditPackage.remediationActions.length} actions · {auditPackage.remediationSummary.overdueCount} overdue</span></div>
        <div className="report-table-wrap" role="region" tabIndex={0} aria-label="Remediation register report table"><table className="report-table"><thead><tr><th>Outcome / action</th><th>Owner</th><th>Priority</th><th>Due</th><th>Status</th><th>Evidence</th></tr></thead><tbody>
