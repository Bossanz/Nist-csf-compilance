...
const designContract = "Versotis Trust Workspace | light + dark brand system | magenta-purple action gradient";
  ...
  return (
    <html lang="en">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=JetBrains+Mono:wght@400;500&family=IBM+Plex+Sans+Thai+Looped:wght@400;500;600&family=Space+Grotesk:wght@400;500;600;700&display=swap"
          rel="stylesheet"
        />
      </head>
      <body data-design-contract={designContract}>
        ...
        OWN-WORLD: Versotis Trust Workspace — paper-white or deep-navy work surfaces, magenta-to-purple action cues, and mono wayfinding labels.
